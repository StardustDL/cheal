...
links = {
    "sbim-1": ["sm2-0"],
    "sbim-2": ["sm2-0"],
    "sm2-0": ["sbim-1", "sbim-2", "nsim-1", "nsim-2", "csdb-0", "csdb-1"],
    "nsim-1": ["sm2-0"],
    "nsim-2": ["sm2-0"],
    "csdb-0": ["sm2-0"],
    "csdb-1": ["sm2-0"],
    "cslb-0": ["sbim-0", "nsim-0"],
    "cslb-1": ["sbim-0", "nsim-0"],
    "sbim-0": ["cslb-0", "cslb-1", "sm2-1", "sm2-2", "sm2-3"],
    "sm2-1": ["sbim-0", "nsim-0"],
    "sm2-2": ["sbim-0", "nsim-0"],
    "sm2-3": ["sbim-0", "nsim-0"],
    "nsim-0": ["cslb-0", "cslb-1", "sm2-1", "sm2-2", "sm2-3"]
}
